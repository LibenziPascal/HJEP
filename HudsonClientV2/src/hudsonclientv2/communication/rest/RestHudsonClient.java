...
/**
 * Initialize connection fron acegi. Offer the ability to retrieve cookies from
 * it to interrogate the server with cookies after
 * 
 * @author libenzi
 *
 */
public class RestHudsonClient {
	...
	public static List<String> init(final String urlRepo, final String username, final String password) throws IOException {
		String urlParameters = "j_username=" + username + "&j_password=" + password + "&rememberMe=false";
		byte[] postData = urlParameters.getBytes(StandardCharsets.UTF_8);
		int postDataLength = postData.length;
		final String request = urlRepo + "/j_acegi_security_check";
