package hudsonclientv2.perspectives;

import hudsonclientv2.views.tree.JobViewsView;
 ...
 * change.
 */
public class HudsonJenkinsPerspective implements IPerspectiveFactory {

	private IPageLayout factory;

	public HudsonJenkinsPerspective() {
		super();
		// Test du commit github
	}
	...
	private void addViews() {
		...
		bottom.addView("hudsonclientv2.views.GridErrorView");
		bottom.addView("org.eclipse.team.ui.GenericHistoryView"); // NON-NLS-1
		bottom.addPlaceholder(IConsoleConstants.ID_CONSOLE_VIEW);

		IFolderLayout topLeft = factory.createFolder("topLeft", // NON-NLS-1
		        IPageLayout.LEFT, 0.25f, factory.getEditorArea());
		topLeft.addView(JobViewsView.ID); // NON-NLS-1
		...
		// 0.50f); //NON-NLS-1
		// TODO ajouter une grille en bas avec les builds lorsqu'on sélectionne
		// un job?
	}
	...
	private void addPerspectiveShortcuts() {
		 ...
		 * factory
		 * .addPerspectiveShortcut("org.eclipse.team.cvs.ui.cvsPerspective");
		 * //NON-NLS-1
